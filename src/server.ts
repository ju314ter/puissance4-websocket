...
function handleGameMessage(message, player: Player, gameGridCollection: Record<string, Grid>, connections) {
...
function handleUserMessage(message, player: Player, gameGridCollection: Record<string, Grid>, connections, connection) {
